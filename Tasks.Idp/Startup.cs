...
using Tasks.Idp.GrantTypeValidator;
using Tasks.Idp.ProfileService;
...
namespace Tasks.Idp
{
    public class Startup
    {
        ...
        {
            services.RegisterRepository(Configuration.GetConnectionString("TasksDB"));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Tasks.Idp", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Tasks.Idp v1"));
            }
